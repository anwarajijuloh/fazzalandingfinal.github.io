/* ! purecounter.js - A simple yet configurable native javascript counter which
 * you can count on. Author: Stig Rex Version: 1.5.0 Url:
 * https://github.com/srexi/purecounterjs License: MIT
 */
!function (e, t) {
        ...
        638: function (e) {
            ...
            function u(e, t) {
                ...
                return e = function (e, t) {
                    if (t.filesizing || t.currency) {
                        e = Math.abs(Number(e));
                        var r = 1e3,
                            n = t.currency && "string" == typeof t.currency
                                ? t.currency
                                : "",
                            o = t.decimals || 1,
                            i = [
            ...
            e.exports = function () {
                ...
                function v(e) {
                    ...
                    return o(
                        0 != i.length
                            ? Object.assign.apply(Object, [{}].concat(r(i.map((function (e) {
                                var r = e.name,
                                    n = e.value;
